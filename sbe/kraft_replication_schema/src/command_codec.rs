...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for CommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> CommandEncoder<'a> {
        ...
        #[inline]
        pub fn batch_id_at(&mut self, index: usize, value: u8) {
            let offset = self.offset;
            let buf = self.get_buf_mut();
            buf.put_u8_at(offset + index, value);
        }

        /// primitive array field 'batchId'
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0_u8
        ...
        /// - version: 0
        #[inline]
        pub fn batch_id(&mut self, value: &[u8]) {
        ...
        /// primitive array field 'batchId' from an Iterator
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0_u8
        /// - characterEncoding: US-ASCII
        ...
        /// - version: 0
        #[inline]
        pub fn batch_id_from_iter(&mut self, iter: impl Iterator<Item = u8>) {
            let offset = self.offset;
            let buf = self.get_buf_mut();
        ...
        /// primitive array field 'batchId' with zero padding
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0_u8
        /// - characterEncoding: US-ASCII
        ...
        /// - version: 0
        #[inline]
        pub fn batch_id_zero_padded(&mut self, value: &[u8]) {
            let iter = value.iter().copied().chain(std::iter::repeat(0_u8)).take(36);
            self.batch_id_from_iter(iter);
        }
...
pub mod decoder {
    ...
    impl ActingVersion for CommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }

...
pub use decoder::LogEntryDecoder;
pub use encoder::LogEntryEncoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for LogEntryEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for LogEntryEncoder<'a> {
        #[inline]
    ...
    impl<'a> LogEntryEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn term(&mut self, value: u64) {
...
pub mod decoder {
    ...
    impl ActingVersion for LogEntryDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for LogEntryDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for LogEntryDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }

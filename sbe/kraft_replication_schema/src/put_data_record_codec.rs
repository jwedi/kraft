...
pub use decoder::PutDataRecordDecoder;
pub use encoder::PutDataRecordEncoder;
...
pub mod encoder {
    ...
    pub struct PutDataRecordEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for PutDataRecordEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for PutDataRecordEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct PutDataRecordDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for PutDataRecordDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for PutDataRecordDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for PutDataRecordDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
